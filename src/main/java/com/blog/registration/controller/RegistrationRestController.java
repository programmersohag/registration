...
import com.blog.registration.model.PasswordDto;
import com.blog.registration.model.User;
import com.blog.registration.model.UserDto;
...
public class RegistrationRestController {
    ...
    public GenericResponse resetPassword(final HttpServletRequest request, @RequestParam("email") final String userEmail) {
        final User user = userService.findUserByEmail(userEmail).get();
        if (user != null) {
    ...
    public GenericResponse changeUserPassword(final Locale locale, @Valid PasswordDto passwordDto) {
        final User user = userService.findUserByEmail(((User) SecurityContextHolder.getContext().getAuthentication().getPrincipal()).getEmail()).get();
