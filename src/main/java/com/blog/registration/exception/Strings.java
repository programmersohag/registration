...
public class Strings {
     ...
     * Error message shown when question is not found
     */
    public static final String ASSESSES_NOT_FOUND = "Assesses not found";
     ...
     */
    public static final String PUBLISH_SUCCESSFUL = "KPI is Published Successfully";
    public static final String PUBLISH_UNSUCCESSFUL = "KPI is Not Published!";
